...
class Query extends Core
{
    ...
    protected function _prepareSelect()
    {
       ...
       return sprintf($template, $fields, $this->_table, $join, $where, $order, $limit, $like);
    }
    ...
    public function like($type,$pattern)
    {
